...
BAML automatically generates a server action and React hook for your BAML functions, with built-in support for both streaming and non-streaming modes. For details on the generated hooks, see [Generated Hooks](/ref/generators/framework-generators/react-next-js/generated-hooks).
...
import { useWriteMeAStory } from "@/baml_client/react/client";
...
### Core Concepts
- [Generated Hooks](/ref/generators/framework-generators/react-next-js/generated-hooks) - Auto-generated hooks for each BAML function
- [useBamlAction](/ref/generators/framework-generators/react-next-js/use-baml-action) - Generic hook for server actions
- [Server Action](/ref/generators/framework-generators/react-next-js/server-action) - Server-side integration

### Hook Configuration
- [Hook Props](/ref/generators/framework-generators/react-next-js/hook-props) - Configuration options for hooks
- [Hook Result](/ref/generators/framework-generators/react-next-js/hook-result) - Return value types and states
- [Return Types](/ref/generators/framework-generators/react-next-js/return-types) - Type utilities for responses
- [Stream Response](/ref/generators/framework-generators/react-next-js/stream-response) - Streaming support and types
- [Error Types](/ref/generators/framework-generators/react-next-js/error-types) - Error handling and types
